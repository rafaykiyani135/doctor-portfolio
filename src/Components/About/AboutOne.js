                        ...
                        <div className="about-us-one-right mt-5 mt-lg-0">
                            ...
                            <div className="fun-fact-section ">
                                <div className="single-funfact-one">
                                    <span><CountUp end={500} duration={3.75} /></span>
                                    <p>Happy Patients</p>
                                </div>
                                <div className="single-funfact-one sp-fun">
                                    <span><CountUp end={88} duration={2.75} /></span>
                                    <p>Qualified Doctors</p>
                                </div>
                                <div className="single-funfact-one">
                                    <span><CountUp end={25} duration={3.75} /></span>
                                    <p>Years Experience</p>
                                </div>
                                <div className="single-funfact-one sp-fun">
                                    <span><CountUp end={55} duration={3.75} /></span>
                                    <p>Dental Awards</p>
                                </div>
                                <span className="line" />
                            </div>
